...
<label class="field wide"><span data-i18n="settings.globalResets">全员重置时间（每行一个 ISO-8601 时间）</span><textarea id="globalResetTimes" rows="4" spellcheck="false"></textarea></label>
